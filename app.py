...
sidebar = html.Div(
    [
        ...
        dds_orgs,
        html.H5(filter_category_2, style={'padding-top':'1rem'}),
        dds_programs,
...
def build_map(data):
    # try:
        ...
        if orgs_map.empty:
            ...
            map_fig = make_map(orgs_map, 'Latitude', 'Longitude', peeps_esc, geojson_featureidkey, esc_count_df, 'ESC', 'Organizations', map_center_lat, map_center_lon, map_zoom=map_zoom, hover_data=['Education_Service_Center', "Custom_Region"])
